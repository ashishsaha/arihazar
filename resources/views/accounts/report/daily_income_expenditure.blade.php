@extends('layouts.app')
@section('title','দৈনিক আয় ব্যয় হিসাব')
@section('style')
    <style>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('report.daily_income_expenditure') }}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="start_date">তারিখ <span class="text-danger">*</span></label>
                        ...
                        <div class="table-responsive-sm" id="printArea">
                            <div class="row print-heading">
                                <div class="col-12">
                                    ...
                                    <h5 class="text-center m-0 mb-2" style="font-size: 19px !important;">দৈনিক আয় ব্যয় হিসাব</h5>
                                    <h6 class="text-center m-0 mb-2" style="font-size: 19px !important;">ফরম -৯১ বিধি -১৮৭ ও ২৪৯</h6>
