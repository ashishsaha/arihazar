                        ...
                        <div class="table-responsive-sm" id="printArea">
                            <div class="row print-heading">
                                <div class="col-12">
                                    ...
                                    <h3 class="text-center m-0 mb-2" style="font-size: 19px !important;">ট্যাক্স  বিবরণ</h3>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($taxs as $tax)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ enNumberToBn(\Carbon\Carbon::parse($tax->receive_datwe)->format('d-m-Y')) }}</td>
                                            <td class="text-left">{{ $tax->khat_name }}</td>
                                            <td class="text-left">{{ $tax->khat_des }}</td>
                                            <td class="text-right">{{ enNumberToBn(number_format($tax->amount,2)) }}</td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        <th colspan="4"  class="text-right"><strong>সর্বমোট</strong></th>
                                        <th  class="text-right"><strong>{{ enNumberToBn(number_format($taxs->sum('amount'),2)) }}</strong></th>
                                    </tr>
                                    </tbody>
                                </table>
