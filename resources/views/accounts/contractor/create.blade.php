@extends('layouts.app')
@section('title','ঠিকাদার সংযুক্তি')
@section('style')
    <style>
        ...
        <div class="col-12">
            <div class="card card-outline card-default">
                <div class="card-header">
                  <div class="card-title">ঠিকাদার সংযুক্তি তথ্য</div>
                </div>
                <!-- /.card-header -->
                <form enctype="multipart/form-data" action="{{ route('contractor.create') }}" class="form-horizontal"
                      method="post">
                    @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row {{ $errors->has('proprietor_name') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('proprietor_name') }}" name="proprietor_name" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('address') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="address" class="form-control"
                                      id="address" placeholder="বেতন হিসাব নং">{{ old('address') }}</textarea>
                            @error('address')
                            <span class="help-block">{{ $message }}</span>
                            @enderror
                        </div>
