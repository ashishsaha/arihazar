@extends('layouts.app')
@section('title','বেতন প্রস্তুত করুন')
@section('content')
    <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                <div class="card-header">
                    <h3 class="card-title">বেতন প্রস্তুতের তথ্য</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('employee_salary_process') }}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
        ...
        $(function (){
            ...
            $("#year").change(function (){
                ...
                if(year != ''){
                    $.ajax({
                        method: "GET",
                        url: "{{ route('get_salary_process_months') }}",
                        data: { year: year }
                    }).done(function( data ) {
