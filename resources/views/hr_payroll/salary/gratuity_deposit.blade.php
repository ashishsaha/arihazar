@extends('layouts.app')
@section('title','কর্মচারীর আনুতোষিক জমা')
@section('content')
    <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <div class="card card-outline card-default">
                <div class="card-header">
                    <h3 class="card-title">কর্মচারীর আনুতোষিক জমা দেওয়ার তথ্য</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('employee_gratuity_deposit') }}">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
        ...
        $(function (){
            ...
            $("#year").change(function (){
                ...
                if(year != ''){
                    $.ajax({
                        method: "GET",
                        url: "{{ route('get_gratuity_deposit_months') }}",
                        data: { year: year }
                    }).done(function( data ) {
