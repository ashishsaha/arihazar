        ...
        <div class="col-12">
            <div class="card card-outline card-default">
                <div class="card-header">
                  <div class="card-title">কর্মচারীর হালনাগাদ তথ্য</div>
                </div>
                <!-- /.card-header -->
                <form enctype="multipart/form-data" action="{{ route('employee.edit',['employee'=>$employee->eid]) }}" class="form-horizontal"
                      method="post">
                    @csrf
                <div class="card-body">
                        ...
                        <div class="col-sm-9">
                            <select name="upangsho" class="form-control select2" id="upangsho">
                                ...
                                @foreach($sections as $section)
                                    <option
                                        {{ old('upangsho',$employee->upananso) == $section->upangsho_id ? 'selected' : '' }} value="{{ $section->upangsho_id }}">{{ $section->upangsho_name }}</option>
                                @endforeach
                            </select>
                            @error('upangsho')
                    ...
                    <div class="form-group row {{ $errors->has('name') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('name',$employee->name) }}" name="name" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('department') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <select name="department" id="department" class="form-control select2">
                                ...
                                <option {{ old('department',$employee->branchid) == $department->id ? 'selected' : '' }} value="{{ $department->id }}">{{ $department->name }}</option>
                                @endforeach
                            </select>
                            @error('department')
                            <span class="help-block">{{ $message }}</span>
                    ...
                    <div class="form-group row {{ $errors->has('designation') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('designation',$employee->designation) }}" name="designation" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('father_name') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('father_name',$employee->fname) }}" name="father_name" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('mother_name') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('mother_name',$employee->mname) }}" name="mother_name" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('joining_date') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('joining_date',$employee->joindate ? \Carbon\Carbon::parse($employee->joindate)->format('d-m-Y') : '') }}" autocomplete="off" name="joining_date" class="form-control date-picker"
                    ...
                    <div class="form-group row {{ $errors->has('joining_present_post_date') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('joining_present_post_date',$employee->presdate ? \Carbon\Carbon::parse($employee->presdate)->format('d-m-Y') : '') }}" autocomplete="off" name="joining_present_post_date" class="form-control date-picker"
                    ...
                    <div class="form-group row {{ $errors->has('retired_date') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('retired_date',$employee->retireddate ? \Carbon\Carbon::parse($employee->retireddate)->format('d-m-Y') : '') }}" autocomplete="off" name="retired_date" class="form-control date-picker"
                    ...
                    <div class="form-group row {{ $errors->has('entertainment_allowance_date') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('entertainment_allowance_date',$employee->srintidate ? \Carbon\Carbon::parse($employee->srintidate)->format('d-m-Y') : '') }}" autocomplete="off" name="entertainment_allowance_date" class="form-control date-picker"
                    ...
                    <div class="form-group row {{ $errors->has('nid_no') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('nid_no',$employee->nid) }}" name="nid_no" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('tin_no') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('tin_no',$employee->tin) }}" name="tin_no" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('birth_day') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('birth_day',$employee->birthdate ? \Carbon\Carbon::parse($employee->birthdate)->format('d-m-Y') : '') }}" autocomplete="off" name="birth_day" class="form-control date-picker"
                    ...
                    <div class="form-group row {{ $errors->has('mobile_no') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('mobile_no',$employee->mob) }}" name="mobile_no" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('email') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="email" value="{{ old('email',$employee->email) }}" name="email" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('salary_account_no') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('salary_account_no',$employee->salaryaccno) }}" name="salary_account_no" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('provident_fund_account_no') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('provident_fund_account_no',$employee->pfaccno) }}" name="provident_fund_account_no" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('gratuity_account_no') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ old('gratuity_account_no',$employee->grataccno) }}" name="gratuity_account_no" class="form-control"
                    ...
                    <div class="form-group row {{ $errors->has('photo') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div id="image-preview">
                                <img style="width:150px;margin-top: 10px" src="{{ asset($employee->photo) }}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row {{ $errors->has('religion') ? 'has-error' :'' }}">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control select2" id="religion" name="religion">
                                ...
                                <option {{ old('religion',$employee->relig) == 1 ? 'selected' : '' }} value="1">মুসলিম</option>
                                <option {{ old('religion',$employee->relig) == 2 ? 'selected' : '' }} value="2">হিন্দু</option>
                            </select>
                            @error('religion')
                            <span class="help-block">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="form-group row {{ $errors->has('status') ? 'has-error' :'' }}">
                        <label for="status" class="col-sm-3 col-form-label">অবস্থা <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <select class="form-control select2" id="status" name="status">
                                <option  value="">অবস্থা নির্ধারণ</option>
                                <option {{ old('status',$employee->satatus) == 1 ? 'selected' : '' }} value="1">অ্যাক্টিভ</option>
                                <option {{ old('status',$employee->satatus) == 2 ? 'selected' : '' }} value="2">রিজাইন</option>
                                <option {{ old('status',$employee->satatus) == 3 ? 'selected' : '' }} value="3">অবসর</option>
                            </select>
                            @error('status')
                            <span class="help-block">{{ $message }}</span>
                            @enderror
...
@section('script')
    <script>
        $(function () {
            var sectionSelected = '{{ old('section',$employee->shaka_id) }}'
