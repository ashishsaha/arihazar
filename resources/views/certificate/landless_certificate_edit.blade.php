    ...
    <div class="content-header" style="background-color: #008b8b">
        <div class="container-fluid">
            <div class="row mb-2 pt-3">
                <div class="col-sm-12">
                    <h4 class="m-0"  style="color:white"><i class="fa fa-file"></i> &nbsp; ভূমিহীন সনদ পত্র যুক্ত করুন </h4>
                </div><!-- /.col -->
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="col-lg-12">
                        <section class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{route('editLandlessCertificate',['certificate'=>$certificate->id])}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group" style="padding: 10px">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control" disabled placeholder="বর্তমান ঠিকানা   লিখুন " rows="5" id="address1" name="present_address">{{$certificate->present_address}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" style="padding: 10px">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control" placeholder="স্থায়ী  ঠিকানা   লিখুন " rows="5" id="address2" name="parmanent_address" disabled>{{$certificate->parmanent_address}}</textarea>
                                            </div>
                                        </div>
                                    </div>
