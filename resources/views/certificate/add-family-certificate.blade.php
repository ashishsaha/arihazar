                    ...
                    <div class="col-lg-12">
                        <section class="card" style="padding: 20px">
                            ...
                            <div class="panel-body">
                                <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{route('add.family_certificate')}}">
                                    {{csrf_field()}}
                                        ...
                                        <div class="row">
                                           <div class="col-md-4" id="test">
                                               ...
                                               <div class="row" style="padding-bottom:20px">
                                                   ...
                                                   <div class="col-lg-12">
                                                       <input type="text" class="form-control" name="wife_comment_array[]" placeholder="মন্ত্যব লিখুন ">
                                                   </div>
                                               </div>
                                    ...
                                    <div class="form-group" style="padding: 10px">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control" placeholder="প্রত্যয়ন   লিখুন " rows="5" maxlength="500"  name="certificate_details" ></textarea>
                                            </div>
                                        </div>
                                    </div>
