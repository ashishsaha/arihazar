            ...
            <div class="col-lg-12">
                <section class="card">
                    ...
                    <div class="panel-body" style="background: #fff; color:#000">
                        <a href="{{route('certificate.edit',['id'=>$certificate->id])}}"><button class="btn btn-default float-right" style="margin: 20px">Edit</button></a>
                        ...
                        <div id="printable" class="col-md-10 offset-1">
                            <div class="print_area">
                                ...
                                <div class="col-md-12" style="font-size:16px;line-height: 30px;text-align: justify;">
                                    ...
                                    @if(!is_null($certificate->parmanent_address))
                                        স্থায়ী ঠিকানা :  {{$certificate->parmanent_address}}।
                                    @endif
                                    @if(!is_null($certificate->present_address))
                                        বর্তমান  ঠিকানা :  {{$certificate->present_address}}।
                                    @endif
                                ...
                                <div class="print-footer">
                                    ...
                                    <div class="footer-content2" style="text-align: center;">
...
@section('script')
    <script>
        ...
        function getprint(id){
            ...
            $('body').html($('#'+id).html());
            window.print();
            window.location.replace(APP_URL+"/show-all-certificate")
        }
