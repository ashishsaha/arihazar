            ...
            <div class="col-lg-12">
                <section class="card">
                    ...
                    <div class="card-body" style="background: #fff; color:#000">
                        <a href="{{route('unmarriage.certificate_bn.edit',['id'=>$certificate->id])}}"><button class="btn btn-default float-right" style="margin: 20px">Edit</button></a>
                        ...
                        <div id="printable" class="col-md-10 offset-1">
                            <div class="print_area">
                                <div class="header-area" >
                                    ...
                                    <div class="right-header" style="font-size: 18px;">তারিখ :- <sapn style="border-bottom: dotted 1px black">{{ str_replace($en, $bn, date("d-m-Y")) }}</sapn></div>
                                </div>
                                <br style="clear: both">
...
@section('script')
    <script>
        ...
        function getprint(id){
            ...
            $('body').html($('#'+id).html());
            window.print();
            window.location.replace(APP_URL+"/show-all-unmarriage-certificate-bn")
        }
