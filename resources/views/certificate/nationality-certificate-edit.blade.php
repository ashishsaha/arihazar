                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{route('nationality.certificate.edit',$certificate->id)}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group" style="padding: 10px;width:100%">
                                        <div class="row">
                                            <label for="inputSuccess" class="control-label col-lg-12"><strong  style="color:white">  কাউন্সিলর যুক্ত করুন  :  </strong></label>
                                            <div class="col-lg-12">
                                                <select class="form-control" name="counselor_id" required>
                                                    ...
                                                    @foreach($counselors as $item)
                                                        ...
                                                        ?>
                                                        <option value="{{$item->id}}" {{$item->id==$certificate->counselor_id?'selected':''}}><?php echo $counselor_name[0];?>-{{$item->word_no}}</option>
                                                    @endforeach
