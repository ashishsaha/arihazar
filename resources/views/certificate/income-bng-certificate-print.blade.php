            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body" style="background: #fff; color:#000">
                        <a href="{{route('income.certificate_bn.edit',['id'=>$certificate->id])}}"><button class="btn btn-default float-right" style="margin: 20px">Edit</button></a>
...
@section('script')
    <script>
        ...
        function getprint(id){
            ...
            $('body').html($('#'+id).html());
            window.print();
            window.location.replace(APP_URL+"/show-all-income-certificate-bn")
        }
