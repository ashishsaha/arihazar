            ...
            <div class="col-md-12" style="background-color: #008b8b">
                <div class="card" style="background-color: #008b8b">
                    <div class="card-header">
                        <h3 class="card-title"style="color:white"> নাগরিত্ব  সনদ পত্র সমূহের তালিকা   </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <table id="myTable" class="table  table-bordered dataTable" role="grid" aria-describedby="example1_info">
                                    ...
                                    @foreach($all_certificate as $certificate)
                                        ...
                                        <tr role="row" class="<?php echo $sl%2==0?'even':'odd'; ?>">
                                            ...
                                            <td>
                                                <a href="{{route('nationality.certificate.print',['id'=>$certificate->id])}}" target="_blank"><button class="btn btn-default btn-sm"><i class="fa fa-print"></i></button></a>
                                                <a href="{{route('nationality.certificate.edit',['id'=>$certificate->id])}}" target="_blank"><button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button></a>
