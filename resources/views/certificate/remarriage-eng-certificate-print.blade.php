            ...
            <div class="col-lg-12">
                <section class="card">
                    ...
                    <div class="card-body" style="background: #fff; color:#000">
                        <a href="{{route('remarriage.certificate_en.edit',['id'=>$certificate->id])}}"><button class="btn btn-default float-right" style="margin: 20px">Edit</button></a>
                            ...
                            <div class="print_area">
                                ...
                                <div class="print-footer">
                                    ...
                                    <div class="footer-content2" style="text-align: center;padding-top: 10px">
                                        ...
                                        <strong>Araihazar Municipality , Araihazar</strong>
                                    </div>
                                </div>
...
@section('script')
    <script>
        ...
        function getprint(id){
            ...
            $('body').html($('#'+id).html());
            window.print();
            window.location.replace(APP_URL+"/show-all-remarriage-certificate-en")
        }
