    ...
    <div class="content-header" style="background-color: #008b8b">
        <div class="container-fluid">
            <div class="row mb-2 pt-3">
                <div class="col-sm-12">
                    <h4 class="m-0"  style="color:white"><i class="fa fa-file"></i> &nbsp; নাগরিকত্ব সনদ পত্র যুক্ত করুন </h4>
                </div><!-- /.col -->
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="col-lg-12">
                        <section class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{route('add.nationality.certificate')}}">
                                    {{csrf_field()}}
                                      ...
                                      <div class="row" style="width:100%;padding:15px">
                                               <!-- <textarea class="form-control"  placeholder=" ঠিকানা   লিখুন " rows="5"  name="address"></textarea>-->
                                    			  ...
                                    			  <fieldset class="col-md-4">
                                					...
                                					<div class="card card-default">
                                						<div class="card-body">
                                							<input type="text" class="form-control" placeholder=" থানার  নাম  লিখুন " value="আড়াইহাজার" name="thana" required
                                						</div>
                                                    </div>
                                    			  ...
                                    			  <fieldset class="col-md-4">
                                					...
                                					<div class="card card-default">
                                						<div class="card-body">
                                						<input type="text" class="form-control" placeholder=" উপজেলা লিখুন " value="আড়াইহাজার উপজেলা" name="upazila" require
                                						</div>
                                                    					</div>
                                    ...
                                    <div class="form-group" style="padding: 10px;width:100%">
                                        <div class="row">
                                            <label for="inputSuccess" class="control-label col-lg-12"><strong  style="color:black">  কাউন্সিলর যুক্ত করুন  :  </strong></label>
                                            <div class="col-lg-12">
                                    ...
                                    <div class="form-group" style="padding: 10px;width:100%;padding:15px">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control" placeholder="প্রত্যয়ন   লিখুন " rows="5" maxlength="500" required name="certificate_details">আমার জানামতে তিনি আড়াইহাজার পৌরসভার একজন স্থায়ী বাসিন্দা এবং  জন্মসূত্রে বাংলাদেশের নাগরিক।  তাহার স্বভাব চরিত্র ভালো এবং সমাজ বিরোধী কোন কর্মকান্ডে জড়িত নহে</textarea>
                                            </div>
                                        </div>
                                    </div>
