                  ...
                  <div class="col-lg-12">
                      <section class="card">
                          ...
                          <div class="panel-body">
                              <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{route('addLandlessCertificate')}}">
                                  {{csrf_field()}}
                                  <div class="form-group" style="padding: 10px">
                                     <div class="row" >
                                         <label for="inputSuccess" class="control-label col-lg-12"><strong  style="color:color"> নাম :  *</strong></label>
                                         <div class="col-lg-12">
                                  ...
                                  <div class="form-group" style="padding: 10px">
                                      <div class="row">
                                          ...
                                          <div class="col-lg-12">
                                              <textarea class="form-control" placeholder="প্রত্যয়ন   লিখুন " rows="5" maxlength="500" required name="certificate_details"> আমার জানামতে তিনি একজন ভূমিহীন ।  </textarea>
                                          </div>
                                      </div>
                                  </div>
