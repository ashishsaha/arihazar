            ...
            <div class="col-lg-12">
                <section class="card">
                    ...
                    <div class="card-body" style="background: #fff; color:#000">
                        <a href="{{route('nationality.certificate_eng.edit',['id'=>$certificate->id])}}"><button class="btn btn-default float-right" style="margin: 20px">Edit</button></a>
                        ...
                        <div id="printable" class="col-md-10 offset-1">
                            <div class="print_area">
                                ...
                                <div class="col-md-12" id="pottoyon_text"  style="">
                                    ...
                                    It is here by certified that, {{$certificate->name}}, Father/Husband : {{$certificate->father_husband}}, Mother : {{$certificate->mother}},
                                ...
                                <div class="print-footer">
                                    ...
                                    <div class="footer-content2" style="text-align: center;padding-top: 10px">
                                        ...
                                        <strong>Araihazar Municipality , Chittagong</strong>
                                    </div>
                                </div>
...
@section('script')
    <script>
        ...
        function getprint(id){
            ...
            $('body').html($('#'+id).html());
            window.print();
            window.location.replace(APP_URL+"/show-all-nationality-certificate-eng")
        }
