    ...
    <div class="content-header" style="background-color: #008b8b">
        <div class="container-fluid">
            <div class="row mb-2 pt-3">
                <div class="col-sm-12">
                    <h4 class="m-0"  style="color:white"><i class="fa fa-file"></i> &nbsp; Add Unmarried Certificate </h4>
                </div><!-- /.col -->
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-lg-12">
                        <section class=card>
                            ...
                            @endif
                            <div class="card-body">
                                <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{route('add.unmarriage.certificate.en')}}">
                                    {{csrf_field()}}
                                    ...
                                    <div class="row" style="width:100%;padding:15px">
                                        ...
                                        <fieldset class="col-md-4">
                                            ...
                                            <div class="card card-default">
                                                <div class="card-body">
                                                    <input type="text" class="form-control" placeholder=" থানার  নাম  লিখুন " value="Araihazar" name="thana" required>
                                                </div>
                                            </div>
                                        ...
                                        <fieldset class="col-md-4">
                                            ...
                                            <div class="card card-default">
                                                <div class="card-body">
                                                    <input type="text" class="form-control" placeholder=" উপজেলা লিখুন " value="Araihazar" name="upazila" required>
                                                </div>
                                            </div>
                ...
                <div class="form-group" style="padding: 10px;width:100%;padding:15px">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <textarea class="form-control" placeholder="প্রত্যয়ন   লিখুন " rows="5" maxlength="500" required name="certificate_details">I know.He/She is a parmanent resident of Araihazar Municipality and is a native of Bangladesh by birth.To my knowledge,He/she was not involved in any marriage.</textarea>
                        </div>
                    </div>
                </div>
