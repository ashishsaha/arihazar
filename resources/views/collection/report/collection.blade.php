    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-default">
                ...
                <div class="card-body">
                    <form action="{{ route('collection.report.collection') }}" method="get">
                        <div class="row">
                            <div class="col-md-3">
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-bordered">
                              <tr>
                                    ...
                                    <th class="text-center">প্রদানকারী</th>
                            ...
                            @if(count($collections) > 0)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $collection->area->area_name }}</td>
                                ...
                                @endforeach
                                <tr>
                                    <th colspan="6" class="text-right">সর্বমোট:</th>
