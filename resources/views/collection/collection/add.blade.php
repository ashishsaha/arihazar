    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" action="{{ route('collection.add') }}" class="form-horizontal" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row {{ $errors->has('name') ? 'has-error' :'' }}">
                            <label for="name" class="col-sm-2 col-form-label">প্রদানকারীর নাম <span class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('name') }}" name="name" class="form-control" id="name" placeholder="নাম">
                                @error('name')
                        ...
                        <div class="form-group row {{ $errors->has('mobile_no') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('mobile_no') }}" name="mobile_no" class="form-control" id="mobile_no" placeholder="প্রদানকারীর মোবাইল নম্বর">
                                @error('mobile_no')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('holding_no') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('holding_no') }}" name="holding_no" class="form-control" id="holding_no" placeholder="প্রদানকারীর হোল্ডিং নম্বর">
                                @error('holding_no')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('area') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" id="area" name="area">
                                    ...
                                    <option {{ old('area') == $area->id ? 'selected' : '' }} value="{{ $area->id }}">{{ $area->area_name }}</option>
                                    @endforeach
                                </select>
                                @error('area')
                                <span class="help-block">{{ $message }}</span>
                        ...
                        <div class="form-group row {{ $errors->has('vat') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('vat',0) }}" name="vat" class="form-control" id="vat" placeholder="ভ্যাট">
                                @error('vat')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row {{ $errors->has('sub_total') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly value="{{ old('sub_total') }}" name="sub_total" class="form-control" id="sub_total" placeholder="সাব টোটাল">
                                @error('sub_total')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('discount_type') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <select name="discount_type" id="discount_type" class="form-control">
                                    <option {{ old('discount_type') == 1 ? 'selected' : '' }} value="1">শতাংশ</option>
                                    <option {{ old('discount_type') == 2 ? 'selected' : '' }} value="2">পরিমাণ</option>
                                </select>
                                @error('discount_type')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row {{ $errors->has('discount') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ old('discount',0) }}" name="discount" class="form-control" id="discount" placeholder="ডিসকাউন্ট">
                                @error('discount')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group row {{ $errors->has('grand_total') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" readonly value="{{ old('grand_total') }}" name="grand_total" class="form-control" id="grand_total" placeholder="গ্রান্ড টোটাল">
                                @error('grand_total')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row {{ $errors->has('date') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" autocomplete="off" value="{{ old('date',date('d-m-Y')) }}" name="date" class="form-control date-picker" id="date" placeholder="তারিখ">
                                @error('date')
                                <span class="help-block">{{ $message }}</span>
                                @enderror
                            </div>
...
@section('script')
    <script>
        $(function (){
                ...
                var selectedSubTYpe = '{{ old('sub_type') }}';
                //Select Type
