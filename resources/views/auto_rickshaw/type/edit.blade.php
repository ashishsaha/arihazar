@extends('layouts.app')
@section('title','যানবাহন লাইসেন্সের ধরণ সংশোধন')
@section('content')
        <div class="row">
            <div class="col-lg-12">
                <section class="card card-default">
                    <header class="card-header">
                        <h3 class="card-title">যানবাহন লাইসেন্সের ধরণ সংশোধন</h3>
                    </header>
                    <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{ route('auto_rickshaw.type.edit',['type'=>$type->id]) }}">
                        {{csrf_field()}}
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <select name="type" class="form-control select2" >
                                        ...
                                        <option {{ $type->type == 1 ? 'selected' : '' }} value="1">মালিক</option>
                                        <option {{ $type->type == 2 ? 'selected' : '' }} value="2">চালক</option>
                                    </select>
                                    @error('type')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ $type->name }}" class="form-control" placeholder="খাতের নাম" id="" name="name" >
                                    @error('name')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ $type->fees }}" class="form-control" placeholder="ধার্যকৃত লাইসেন্স ফি" id="fees" name="fees" >
                                    @error('fees')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input readonly value="{{ $type->vat }}" type="text" class="form-control" placeholder="১৫% ভ্যাট" id="vat" name="vat" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ $type->tin_plate }}" class="form-control" placeholder="টিন প্লেটের মূল্য" id="tin_plate" name="tin_plate">
                                    @error('tin_plate')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input readonly type="text" class="form-control" value="{{ $type->total }}" placeholder="মোট টাকা" id="total" name="total">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" value="{{ $type->name_change_fees }}" placeholder="নাম পরিবর্তন ফি" id="name_change_fees" name="name_change_fees">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" value="{{ $type->others }}" class="form-control" placeholder="অন্যান্য মূল্য" id="others" name="others">
                                    @error('others')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
