            ...
            <div class="col-lg-12">
                <section class="card card-default">
                    <header class="card-header">
                       <h3 class="card-title">যানবাহন চালকের লাইসেন্স যুক্তকরন</h3>
                    </header>
                    <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{ route('auto_rickshaw.vehicle_license') }}">
                        @csrf
                    <div class="card-body">

                            <div class="form-group row">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2"><strong> ধরন *</strong></label>
                                <div class="col-lg-10">
                                    <select class="form-control m-bot15 select2" name="type" id="type">
                                        ...
                                        @foreach($types as $type)
                                            @if ($type->name_change_fees > 0)
                                                <option {{ old('type') == $type->id ? 'selected' : '' }} value="{{ $type->id }}">{{ $type->name }}  (নাম পরিবর্তন সহ)</option>
                                            @else
                                                <option {{ old('type') == $type->id ? 'selected' : '' }} value="{{ $type->id }}">{{ $type->name }}  (নাম পরিবর্তন ছাড়া)</option>
                                            @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="চালকের নাম" id="driver_name" name="driver_name" >
                                    @error('driver_name')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="পিতার নাম" id="father_name" name="father_name" >
                                    @error('father_name')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="মাতার নাম" id="mother_name" name="mother_name" >
                                    @error('mother_name')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2"><strong>স্থায়ী  ঠিকানা*</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="চালকের ঠিকানা অস্থায়ী  ঠিকানা" id="address" name="address" >
                                    @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2"><strong>বর্তমান ঠিকানা *</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="চালকের বর্তমান ঠিকানা" id="current_address" name="current_address" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="লাইসেন্স নম্বর" id="license_no" name="license_no" >
                                    @error('license_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2"><strong>টাকার রিসিভ নং *</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="টাকার রিসিভ নং" id="taka_receive_no" name="taka_receive_no" >
                            ...
                            <div class="form-group row">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2"><strong>ডেলিভারি তারিখ *</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" autocomplete="off" class="form-control date-picker" name="delivery_date" value="{{date('d-m-Y')}}" >
                                    @error('delivery_date')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
