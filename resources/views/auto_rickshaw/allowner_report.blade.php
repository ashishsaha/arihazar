@extends('layouts.app')
@section('title','মালিকের লাইসেন্স রিপোর্ট')
@section('style')
    <style>
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('auto_rickshaw.report_owner_license') }}">
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <label for=""></label>
                                <br>
                                <input type="submit" name="submit" class="btn btn-success bg-gradient-success pull-right mt-3" value="খুজুন">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="adv-table" id="printable">
                            <div class="report-info text-center">
                                ...
                                <h4>যানবাহন মালিকের লাইসেন্স রিপোর্ট</h4>
                                <br>
                            </div>
