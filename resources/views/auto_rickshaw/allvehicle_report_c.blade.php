@extends('layouts.app')
@section('title','চালকের লাইসেন্স আদায়')
@section('style')
    <style>
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('auto_rickshaw.report_vehicle_license_collection') }}">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" autocomplete="off" placeholder="তারিখ শুরু" class="form-control date-picker" name="start_date" value="{{ request()->get('start_date') }}" required>
                            </div>
                            <div class="col-md-3">
                                <label for="">তারিখ শেষ <span class="text-danger">*</span></label>
                                <input type="text" autocomplete="off" placeholder="তারিখ শেষ" class="form-control date-picker" name="end_date" value="{{ request()->get('end_date') }}" required>
                            </div>
                            <div class="col-md-12">
                                <label for=""></label>
                                <br>
                    ...
                    <div class="card-body">
                        <div class="table-responsive" id="printable">
                            <div class="report-info text-center">
                                ...
                                <h4>যানবাহন চালকের লাইসেন্স আদায়  রিপোর্ট</h4>
                                <br>
                            </div>
                            <table class="display table table-bordered" id="table">
                                ...
                                @foreach($licences as $licence)
                                    <tr>
                                        ...
                                        <td class="text-right">{{ str_replace($en, $bn,number_format($licence->vat)) }}</td>
                                        <td class="text-right">{{ str_replace($en, $bn,number_format($licence->total,2)) }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                                <tfoot>
                                <tr>
                                    ...
                                    <th class="text-right">{{ str_replace($en, $bn,number_format($licence->sum('total'),2)) }}</th>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
