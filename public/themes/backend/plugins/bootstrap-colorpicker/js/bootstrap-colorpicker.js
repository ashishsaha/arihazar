...
exports.default = {
   ...
   *
   * NoteExport that the ending 'a' of the format meaning "alpha" has currently no effect, meaning that rgb is the same as
   ...
   *
   * NoteExport that if there is no container specified, the inline element
