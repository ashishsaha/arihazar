...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        initDelegatedMapEvents: function() {
            ...
            // NoteExport: legend-elem and legend-label are not in this table because
             ...
             * NoteExport: we filter the event with a timeout to reduce the firing when the mouse moves quickly
             */
             ...
             * NoteExport: timeout filtering is small to update the Tooltip position fast
             */
             ...
             * NoteExport: we don't perform any timeout filtering to clear & reset elem ASAP
             ...
             * NoteExport: we filter the event with a timeout to avoid double click
             */
         ...
         * NoteExport: for SVG, plot.mapElem needs to exists beforehand
         * @param plot object plot element
         */
        ...
        animate: function(element, attrs, duration, callback) {
            ...
            if (duration > 0) {
                ...
                // NoteExport: we don't need to delete from original attribute (they won't be set anyway)
